...
| `bitcoin-max-min-trendrev` | n-day high (MAX, trend-following) and n-day low (MIN, mean-reversion) long-BTC signals \| Rolling n-day max/min price (n=10–50, 10 preferred) \| Daily \| Crypto (Bitcoin BTC/USD) | 45 | Experimental | 2026-05-29 | SSRN 4955617 (Beluška/Vojtko, Sep 2024, Quantpedia); OOS stress test Feb 2022–Aug 2024; MAX OOS: >35% return / ~−12% max DD CLAIMED; exit conditions NOT CONFIRMED; costs not modeled; no peer review |
